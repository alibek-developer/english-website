		...
		<div className='space-y-8'>
			<div>
				...
				<p className='text-slate-600'>
					Savollaringiz bo'lsa yoki bepul konsultatsiya olmoqchi bo'lsangiz, biz
					bilan bog'laning. Men sizga yordam berishdan xursand bo'laman!
				</p>
			</div>
			...
			<div className='bg-sky-50 rounded-xl p-6'>
				...
				<p className='text-sm text-slate-600 mb-4'>
					30 daqiqalik bepul konsultatsiya davomida sizning darajangizni
					aniqlayman va eng mos o'quv rejani tayyorlayman.
				</p>
