...
```bash
git remote add encore encore://english-teacher-course-site-kqs2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/english-teacher-course-site-kqs2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/english-teacher-course-site-kqs2/settings/integrations/github)
